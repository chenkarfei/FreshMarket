...
export const translations: Translations = {
  ...
  "confirm_delete_category": { en: "Are you sure you want to delete this category? This will not delete the items in it.", zh: "您确定要删除此分类吗？这不会删除其中的商品。" },
  "confirm_delete_item": { en: "Are you sure you want to delete this item?", zh: "您确定要删除此商品吗？" },
  "delete_success": { en: "Deleted successfully", zh: "删除成功" },
  "delete_failed": { en: "Failed to delete", zh: "删除失败" },
  "delete_selected": { en: "Delete Selected", zh: "删除所选" },
  "confirm_bulk_delete": { en: "Are you sure you want to delete these {count} items?", zh: "您确定要删除这 {count} 个商品吗？" },
